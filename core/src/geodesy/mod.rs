...
pub use magnetic::{
    MagneticCoeffEntry, MagneticCoefficients, MagneticElements, MagneticModel, WMM_BASE_EPOCH,
    WMM_EARTH_RADIUS_METERS, WMM_MAX_DEGREE,
};
...
pub use spatial::{
    compute_route_deviation, geodesic_intersection, GeodesicPolygon, RouteDeviation,
};
