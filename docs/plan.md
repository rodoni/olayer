...
* **Tasks:**
  ...
  * [x] Develop the **`Symbol Registry`** module for decoding and validation of military tactical codes (NATO SIDC) and civil radio-aids (ICAO).
...
* **Test Plan:**
  ...
  * [x] Validate correct NATO SIDC (APP-6) resolution for affiliations and varied types, testing behavior against unknown or malformed SIDC codes.
